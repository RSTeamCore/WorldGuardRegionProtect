package net.ritasister.wgrp.core.util.wg;
...
public class CheckIntersectionImpl implements CheckIntersection<Player> {
    ...
    public final WorldGuardRegionProtectPlugin worldGuardRegionProtectPlugin;

    public CheckIntersectionImpl(final WorldGuardRegionProtectPlugin worldGuardRegionProtectPlugin) {
    ...
    private boolean checkIntersection(final Region selection, Player player) {
        if (selection instanceof CuboidRegion) {
            ...
            for (final ProtectedRegion rg : set) {
                for (final String region : worldGuardRegionProtectPlugin.getConfigLoader().getConfig().getRegionProtectMap().get(player.getWorld().getName())) {
