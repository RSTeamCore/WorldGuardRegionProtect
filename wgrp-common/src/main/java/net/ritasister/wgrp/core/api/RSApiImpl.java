...
import net.ritasister.wgrp.core.api.entity.EntityCheckTypeProvider;
...
public class RSApiImpl implements RSApi<Entity, Player, Cancellable> {
    ...
    private final WorldGuardRegionProtectPlugin wgrpPlugin;
    ...
    public RSApiImpl(final @NotNull WorldGuardRegionProtectPlugin wgrpPlugin) {
        this.wgrpPlugin = wgrpPlugin;
        this.config = wgrpPlugin.getConfigLoader().initConfig();
