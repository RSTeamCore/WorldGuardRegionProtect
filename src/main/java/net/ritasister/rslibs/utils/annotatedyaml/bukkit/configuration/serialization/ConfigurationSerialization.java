package net.ritasister.rslibs.utils.annotatedyaml.bukkit.configuration.serialization;

import net.ritasister.rslibs.utils.annotatedyaml.bukkit.configuration.Configuration;
...
public class ConfigurationSerialization {
    ...
    private static Map<String, Class<? extends ConfigurationSerializable>> aliases = new HashMap<String, Class<?
    ...
    @Nullable
    protected ConfigurationSerializable deserializeViaCtor(@NotNull Constructor<? extends ConfigurationSerializable> ctor,
     ...
     */
    @Nullable
    public static ConfigurationSerializable deserializeObject(@NotNull Map<String, ?> args, @NotNull Class<?
            extends ConfigurationSerializable> clazz) {
